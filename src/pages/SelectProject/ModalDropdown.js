...
export default class ModalDropdown extends Component {
      ...
      >
        {children || (
          <View style={styles.button}>
            ...
            <Ionicons name="ios-arrow-down" size={25} color={"black"} />
            </View>
          </View>
        )}
      </TouchableOpacity>
  ...
  _calcPosition() {
    ...
    const positionStyle = {
      ...
      top: showInBottom
        ? this._buttonFrame.y + (1.4*this._buttonFrame.h)
...
const styles = StyleSheet.create({
  ...
  dropdown: {
    ...
    width: (Dimensions.get("window").width/2)-(2*StyleSheet.hairlineWidth),
